/*
 * @Author: Mengsen.Wang
 * @Date: 2020-02-24 20:21:54
 * @Last Modified by:   Mengsen.Wang
 * @Last Modified time: 2020-02-24 20:21:54
 */
/*
 * Our own header, to be include before all standard system headers.
 */
...
#include <string.h> /* for concenience */
...
typedef void Sigfunc(int); /* for a signal handlers */
